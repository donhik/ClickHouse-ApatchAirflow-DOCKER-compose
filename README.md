...
[![Стек](https://img.shields.io/badge/Tech_Stack-Airflow%20%7C%20ClickHouse%20%7C%20Docker-0066cc?logo=apache-airflow&logoColor=white)](https://airflow.apache.org/)
[![Сбор каждые 4 часа](https://img.shields.io/badge/Update_Every-4h-blue)](https://hh.ru)
...
![Дашборд](https://img.shields.io/badge/Preview-%231%20Dashboard%20Screenshot-blue?style=flat)  
*Скриншот дашборда с кнопками «Открыть» для перехода к вакансиям*
